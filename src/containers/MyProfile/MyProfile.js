                ...
                <Col xs={12}>
                  ...
                  :
                    <div className={styles.mb10 + ' ' + styles.headline}>
                        <input className={styles.fixFormStyle} type="text" ref="nickname" name="nickname" id="nickname" defaultValue={getNickname} onKeyPress={() => this.handleKeyPress('nickname', this.refs.nickname.value, window.event)} />
                      ...
                      :
                        <div>
                          <div className={styles.m15 + ' ' + styles.m0p0}>
                            <div>
                              <input type="text" ref="job" name="job" id="job" className={styles.fixFormStyle + ' ' + styles.pro70} defaultValue={getJob} onKeyPress={() => this.handleKeyPress('job', this.refs.job.value, window.event)} />
                    ...
                    <Col className={styles.m15 + ' ' + styles.topLine} xs={8}>
                      ...
                      :
                        <div>
                          <div className={styles.m15 + ' ' + styles.m0p0}>
                            <div>
                              <input type="text" ref="company" name="company" id="company" className={styles.fixFormStyle + ' ' + styles.pro70} defaultValue={getCompany} onKeyPress={() => this.handleKeyPress('company', this.refs.company.value, window.event)} />
