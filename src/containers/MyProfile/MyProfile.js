                      ...
                      :
                        <div>
                          <div className={styles.m15 + ' ' + styles.m0p0}>
                            <div>
                              <input type="text" ref="job" name="job" id="job" className={styles.fixFormStyle + ' ' + styles.pro70} defaultValue={getJob} onKeyPress={() => this.handleKeyPress('job', this.refs.job.value, event)} />
