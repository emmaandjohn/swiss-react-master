      ...
      blogContentDef.push(
        <div onClick={() => this.loadArticle(entry.articleId)} className={styles.topLine + ' animated fadeInUp col-xs-12 ' + styles.hover}>
          <div className='row'>
            ...
            <div className={'col-sm-3 col-xs-12 ' + styles.techStyle}>{ Object.keys(entry.technologies[0]).map(key => <span alt={entry.technologies[0][key]} className={stylesCommunity.cbs00 + ' ' + stylesCommunity.cbs+key}></span>) }</div>
